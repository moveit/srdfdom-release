...
The packages in the `srdfdom` repository were released into the `rolling` distro by running `/home/jafar/.local/bin/bloom-release srdfdom -t rolling -r rolling` on `Mon, 09 May 2022 09:02:54 -0000`
